...
export const demoHeatmap = (newData: string, config: object): void => {
    ...
    const myVars = ['Efficiency', 'Teamwork', 'Innovation', 'Reliability', 'Leadership', 'Communication', 'Adaptability', 'Initiative', 'Work Ethic', 'Efficiency'];
